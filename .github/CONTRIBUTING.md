...
- Before submitting a new issue or PR, check if it already exists in [issues](https://github.com/tesseracted/tesseract/issues) or [PRs](https://github.com/tesseracted/tesseract/pulls).
...
- GitHub issues: take note of the `needs-approval` label.
  - **For Contributors**:
    - Feature Requests / Refactoring on a Large Scale: Wait for an Tesseract member to approve and remove the `needs-approval` label before you start coding or submitting a PR.
  ...
  - **Our Process**:
    - Issues from anyone not on the Tesseract team automatically receive the `needs-approval` label.
...
2. Create a new branch:
   ...
   ```
3. Follow our getting started guide in our [documentation](https://tesseract.com/docs/contributing/getting-started)

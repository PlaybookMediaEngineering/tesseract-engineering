...
export default function EventsSectionLanding() {
  ...
  return (
    <section className="relative mx-auto mt-32 max-w-[80rem] px-6 text-center md:px-8">
      <h2 className="animate-fade-in translate-y-[-1rem] text-balance bg-gradient-to-br from-black from-30% to-black/40 bg-clip-text py-6 text-5xl font-medium leading-none tracking-tighter text-transparent opacity-0 [--animation-delay:200ms] dark:from-white dark:to-white/40 sm:text-6xl md:text-7xl lg:text-8xl">
        The information you need
        <br className="hidden md:block" /> when you need it.
      </h2>
      <div
        ref={ref}
        className="animate-fade-up relative mx-auto mt-20 w-full max-w-[80%] opacity-0 [--animation-delay:800ms]"
      >
        <BentoCard
          name=""
      ...
      <p className="animate-fade-in mb-12 mt-12 translate-y-[-1rem] text-balance text-lg tracking-tight text-gray-400 opacity-0 [--animation-delay:400ms] md:text-xl">

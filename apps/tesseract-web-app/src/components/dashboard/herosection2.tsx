    ...
    <section className="space-y-6 pb-12 pt-16 lg:py-6">
      <div className="container px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-[500px_1fr] lg:gap-12 xl:grid-cols-[600px_1fr]">
          <Card
            className="animate-fade-up h-full w-full opacity-0"
          ...
          <div
            className="animate-fade-up flex flex-col justify-center space-y-4 opacity-0"
          ...
          >
            <div className="space-y-2">
              ...
              <p
                className="animate-fade-up max-w-[700px] text-gray-500 opacity-0 dark:text-gray-400 md:text-xl lg:text-lg xl:text-xl"
                style={{
            ...
            <div
              className="animate-fade-up flex flex-col gap-2 opacity-0 min-[400px]:flex-row"

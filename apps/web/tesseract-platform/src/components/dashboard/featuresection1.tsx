    ...
    <div className="px-6 py-12">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p
            className="animate-fade-up mt-4 max-w-[42rem] leading-normal text-muted-foreground opacity-0 sm:text-xl sm:leading-8"
          ...
          <dl className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
            {features.map((feature, index) => (
              <div key={index} className="relative pl-9 text-center">
                ...
                <dd
                  className="animate-fade-up mt-2 leading-normal text-muted-foreground opacity-0"
                  style={{

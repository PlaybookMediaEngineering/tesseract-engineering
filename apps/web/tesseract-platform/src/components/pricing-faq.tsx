...
const pricingFaqData = [
  {
    id: "item-1",
    question: "How does Tesseract help with real-time monitoring and analytics?",
    answer:
      "Tesseract provides comprehensive real-time monitoring and analytics by capturing critical business events, tracking user journeys, and offering detailed KPIs and insights. Make data-driven decisions to optimize your business performance.",
  },
  {
    id: "item-2",
    question: "Can I integrate Tesseract with my existing business tools?",
    answer:
      "Absolutely! Tesseract is built with integration in mind. Our comprehensive API allows you to seamlessly connect with your existing business tools, ensuring a smooth addition to your current workflow.",
  },
  {
    id: "item-3",
    question: "What kind of support can I expect with Tesseract?",
    answer:
  ...
  {
    id: "item-4",
    question: "Is my data secure with Tesseract?",
    answer:
  ...
  },
  {
    ...
    answer:
      "The free plan offers basic features that allow you to experience the advantages of Tesseract's real-time monitoring. Our paid plans provide access to more advanced features, including detailed analytics, priority support, and increased event volume.",
  },
  {
    id: "item-6",

...
export const metadata = {
  title: "Tesseract Settings - Customize Your Experience",
  description:
    "Adjust your Tesseract account settings for a personalized real-time monitoring experience. Manage language preferences, account details, and more.",
};

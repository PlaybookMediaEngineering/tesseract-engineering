// This example has relative imports to do type checks, you need to import from "@saasfly/cache"
import { DefaultStatefulContext, Namespace, createCache } from ".."; // @saasfly/cache
import { withEncryption } from "../middleware"; // @saasfly/cache/middleware
import { CloudflareStore, MemoryStore } from "../stores"; // @saasfly/cache/stores

      ...
      <Html className="font-sans text-zinc-800">
        ...
        <Section className="bg-white">
          <Container className="container mx-auto">
            ...
            <Text>
              We're reaching out to let you know that your trial period has come to an end for Tesseract
            ...
            <Text>
              If you want to continue with Tesseract Pro, click the button below, and you can add your
              credit card.
            </Text>

      ...
      <Html className="font-sans text-zinc-800">
        ...
        <Section className="bg-white">
          <Container className="container mx-auto">
            <Heading className="font-sans text-2xl text-semibold">Welcome to Tesseract!</Heading>
            <Text>Hi there!</Text>
            <Text>
              My name is James. I am one of the co-founders of Tesseract. We believe that Tesseract's API
            ...
            <Section>
              ...
              <Text>
                ...
                <li>
                  {" "}
                  <Link href="https://go.tesseract.com/ratelimit">Ratelimiting Quickstart Guide</Link>
                </li>
                <li>
                  <Link href="https://tesseract.com/docs/security"> Why is Tesseract secure? </Link>
                </li>
                <li>
                  {" "}
                  <Link href="https://tesseract.com/discord">Tesseract Community Discord </Link>
                </li>
              </Text>
            </Section>
            <Hr />
